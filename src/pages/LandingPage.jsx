...
import { Ticket, Link as LinkIcon, QrCode, ArrowRight, Check, Users, Sparkles, BarChart3, Mail, Calendar, MapPin, Search, Send, Webhook, Heart, Repeat, Clock } from 'lucide-react';
import EventPassVisual from '../components/EventPassVisual';
  ...
  return (
    <PageShell>
      <div className="landing-page" style={{ background: '#ffffff' }}>
        ...
        <section className="platform-hero">
          ...
          <div
            ...
            style={{
              position: 'relative',
              zIndex: 1,
              padding: 'clamp(56px, 8vw, 104px) var(--spacing-sm) clamp(36px, 5vw, 64px)',
              display: 'flex',
          ...
          >
            <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '22px', maxWidth: '820px' }}>
              <h1
                style={{
            ...
            <div className="animate-fade-in animate-delay-1" style={{ width: '100%', maxWidth: '1000px', marginTop: '4px', display: 'grid', gridTemplateColumns: 'auto 280px', gap: '32px', alignItems: 'center' }}>
              <div style={{
              ...
              {/* Event Pass Mockup */}
              <div style={{ transform: 'rotate(2deg) translateY(-10px)' }}>
                <EventPassVisual />
              </div>
            </div>
          </div>
        ...
        <section id="features" style={{ padding: 'var(--spacing-xl) 0', background: 'transparent' }}>
          <div className="container">
            <div className="text-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', marginBottom: 'var(--spacing-lg)' }}>
              ...
              <p style={{ fontSize: '1.05rem', color: 'var(--color-text-muted)', margin: 0, maxWidth: '560px', lineHeight: 1.55, textAlign: 'center' }}>
        ...
        <section style={{ padding: 'var(--spacing-xl) 0', background: 'transparent' }}>
          <div className="container">
            <div className="text-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', marginBottom: 'var(--spacing-lg)' }}>
              ...
              <p style={{ fontSize: '1.05rem', color: 'var(--color-text-muted)', margin: 0, maxWidth: '560px', lineHeight: 1.55, textAlign: 'center' }}>
                Thoughtful defaults, privacy by design, and tools that quietly stay out of your way.
              </p>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '28px' }}>
              {trustPoints.map((t, i) => (
                <div key={i} className={`animate-fade-in animate-delay-${(i % 3) + 1}`} style={{ display: 'flex', flexDirection: 'column', gap: '12px', textAlign: 'left' }}>
                  <div className="feature-chip chip-primary" style={{ width: '44px', height: '44px', borderRadius: '12px' }}>
                    {t.icon}
                  </div>
        ...
        <section style={{ padding: 'var(--spacing-xl) 0', background: 'transparent' }}>
          <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '18px' }}>
            <div className="text-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
              ...
              <p style={{ fontSize: '1.05rem', color: 'var(--color-text-muted)', margin: 0, maxWidth: '560px', textAlign: 'center' }}>
        ...
        {/* ───────── FOOTER ───────── */}
        <footer style={{ background: 'transparent', borderTop: '1px solid var(--color-border)', padding: '40px 0' }}>
          <div className="container">
            <div
              style={{
                display: 'grid',
